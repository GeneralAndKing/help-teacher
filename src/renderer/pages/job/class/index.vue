<template lang="pug">
  #gak-main
    ...
    el-scrollbar#gak-main-content-class
      el-table(:data='classToJobs', height="250", v-loading="loading")
        el-table-column(type='index', width='40', align="center")
        el-table-column(label='班级', prop="className", width="155px", align="center")
        el-table-column(label='人数', prop='studentNum', width="50px", align="center")
        el-table-column(label='开始时间', prop='startTime', width="100px", sortable, align="center")
        ...
        el-table-column(align="center")
          ...
          template(slot-scope='scope')
            el-button(size='mini', @click='handleSave($event,scope.$index, scope.row)' ) 详情
