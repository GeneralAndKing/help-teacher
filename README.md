...
![主页](build/img/home.png)
主页
![班级管理](build/img/class.png)
班级管理
![学生管理](build/img/classStudent.png).
学生管理
![作业管理](build/img/job.png)
作业管理
![作业信息](build/img/jobinfo.png)
作业信息
![开启服务](build/img/start.png)
开启服务
![实时监控信息](build/img/mon.png)
实时监控信息
![学生文件上传](build/img/stu.png)
学生文件上传
![服务管理](build/img/mon1.png)
服务管理
![监控进度](build/img/mon2.png)
监控进度
![数据可视](build/img/mon3.png)
数据可视
![其他工具](build/img/tools.png)
其他工具
![全班点名](build/img/tools1.png)
全班点名
![关于页面](build/img/about.png)
关于页面